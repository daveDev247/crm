...
namespace FintrakERPIMSDemo.Core.Base
{
    public abstract class FintrakERPIMSDemoQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected FintrakERPIMSDemoQueryBase(string fieldName,
