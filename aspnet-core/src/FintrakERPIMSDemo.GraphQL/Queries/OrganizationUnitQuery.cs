...
using FintrakERPIMSDemo.Core.Base;
using FintrakERPIMSDemo.Core.Extensions;
using FintrakERPIMSDemo.Dto;
using FintrakERPIMSDemo.Types;

namespace FintrakERPIMSDemo.Queries
{
    public class OrganizationUnitQuery : FintrakERPIMSDemoQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
