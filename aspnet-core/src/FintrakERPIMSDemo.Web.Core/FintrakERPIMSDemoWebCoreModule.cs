...
using FintrakERPIMSDemo.Web.Authentication.JwtBearer;
using FintrakERPIMSDemo.Web.Authentication.TwoFactor;
using FintrakERPIMSDemo.Web.Chat.SignalR;
using FintrakERPIMSDemo.Web.Configuration;
using FintrakERPIMSDemo.Web.DashboardCustomization;

namespace FintrakERPIMSDemo.Web
{
    [DependsOn(
        typeof(FintrakERPIMSDemoApplicationModule),
        typeof(FintrakERPIMSDemoEntityFrameworkCoreModule),
    ...
    public class FintrakERPIMSDemoWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public FintrakERPIMSDemoWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(FintrakERPIMSDemoApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FintrakERPIMSDemoWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(FintrakERPIMSDemoWebCoreModule).Assembly);
        }
