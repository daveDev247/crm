...
namespace FintrakERPIMSDemo.Web.Authentication.JwtBearer
{
    public class FintrakERPIMSDemoJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public FintrakERPIMSDemoJwtSecurityTokenHandler()
        {
