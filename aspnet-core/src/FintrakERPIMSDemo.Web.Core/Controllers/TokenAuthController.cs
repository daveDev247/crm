...
using FintrakERPIMSDemo.Web.Models.TokenAuth;
using FintrakERPIMSDemo.Authorization.Impersonation;
...
using FintrakERPIMSDemo.Net.Sms;
using FintrakERPIMSDemo.Notifications;
using FintrakERPIMSDemo.Security.Recaptcha;
using FintrakERPIMSDemo.Web.Authentication.External;
...
namespace FintrakERPIMSDemo.Web.Controllers
{
    ...
    public class TokenAuthController : FintrakERPIMSDemoControllerBase
    {
