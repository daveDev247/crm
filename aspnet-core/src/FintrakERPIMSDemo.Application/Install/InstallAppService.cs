...
namespace FintrakERPIMSDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : FintrakERPIMSDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<FintrakERPIMSDemoDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{FintrakERPIMSDemoConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{FintrakERPIMSDemoConsts.ConnectionStringName}", constring);
        }
