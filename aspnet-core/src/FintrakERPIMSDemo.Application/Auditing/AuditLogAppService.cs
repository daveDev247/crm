...
using FintrakERPIMSDemo.Auditing.Exporting;
...
using EntityHistoryHelper = FintrakERPIMSDemo.EntityHistory.EntityHistoryHelper;

namespace FintrakERPIMSDemo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : FintrakERPIMSDemoAppServiceBase, IAuditLogAppService
    {
