...
using FintrakERPIMSDemo.MultiTenancy.Payments.Paypal;
using FintrakERPIMSDemo.MultiTenancy.Payments.PayPal;
using FintrakERPIMSDemo.MultiTenancy.Payments.PayPal.Dto;

namespace FintrakERPIMSDemo.MultiTenancy.Payments
{
    public class PayPalPaymentAppService : FintrakERPIMSDemoAppServiceBase, IPayPalPaymentAppService
    {
