...
namespace FintrakERPIMSDemo.Authorization.Users.Delegation
{
    [AbpAuthorize]
    public class UserDelegationAppService : FintrakERPIMSDemoAppServiceBase, IUserDelegationAppService
    {
