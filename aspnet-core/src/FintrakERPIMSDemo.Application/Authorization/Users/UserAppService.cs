...
using FintrakERPIMSDemo.Authorization.Permissions;
...
using FintrakERPIMSDemo.Authorization.Users.Exporting;
...
namespace FintrakERPIMSDemo.Authorization.Users
{
    ...
    public class UserAppService : FintrakERPIMSDemoAppServiceBase, IUserAppService
    {
