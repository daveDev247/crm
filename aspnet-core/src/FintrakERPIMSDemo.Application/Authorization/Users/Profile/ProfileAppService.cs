...
using FintrakERPIMSDemo.Authorization.Users.Profile.Cache;
    ...
    public class ProfileAppService : FintrakERPIMSDemoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("FintrakERPIMSDemo",
