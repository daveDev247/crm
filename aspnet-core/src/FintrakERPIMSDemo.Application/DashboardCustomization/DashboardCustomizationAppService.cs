...
using FintrakERPIMSDemo.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace FintrakERPIMSDemo.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : FintrakERPIMSDemoAppServiceBase, IDashboardCustomizationAppService
    {
