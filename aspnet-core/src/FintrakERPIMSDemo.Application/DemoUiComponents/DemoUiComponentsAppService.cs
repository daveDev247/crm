...
using FintrakERPIMSDemo.DemoUiComponents.Dto;

namespace FintrakERPIMSDemo.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : FintrakERPIMSDemoAppServiceBase, IDemoUiComponentsAppService
    {
