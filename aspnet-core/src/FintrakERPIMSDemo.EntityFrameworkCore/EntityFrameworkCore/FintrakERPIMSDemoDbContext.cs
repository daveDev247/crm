...
using FintrakERPIMSDemo.MultiTenancy.Accounting;
...
{
    public class FintrakERPIMSDemoDbContext : AbpZeroDbContext<Tenant, Role, User, FintrakERPIMSDemoDbContext>, IAbpPersistedGrantDbContext
    {
        public virtual DbSet<Customer> Customers { get; set; }

        public virtual DbSet<Person> Persons { get; set; }

        public virtual DbSet<SomeOne> SomeOnes { get; set; }
        ...
        public FintrakERPIMSDemoDbContext(DbContextOptions<FintrakERPIMSDemoDbContext> options)
            : base(options)
        {
