...
{
    public class SubscriptionPaymentRepository : FintrakERPIMSDemoRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<FintrakERPIMSDemoDbContext> dbContextProvider)
