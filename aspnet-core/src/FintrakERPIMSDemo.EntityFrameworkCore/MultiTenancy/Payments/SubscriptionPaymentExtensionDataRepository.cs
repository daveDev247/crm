...
using FintrakERPIMSDemo.EntityFrameworkCore.Repositories;

namespace FintrakERPIMSDemo.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : FintrakERPIMSDemoRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<FintrakERPIMSDemoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
