...
using FintrakERPIMSDemo.Authorization.Ldap;
...
using FintrakERPIMSDemo.DashboardCustomization.Definitions;
using FintrakERPIMSDemo.Debugging;
using FintrakERPIMSDemo.DynamicEntityParameters;
using FintrakERPIMSDemo.Features;
using FintrakERPIMSDemo.Friendships;
using FintrakERPIMSDemo.Friendships.Cache;
using FintrakERPIMSDemo.Localization;
using FintrakERPIMSDemo.MultiTenancy;
using FintrakERPIMSDemo.Net.Emailing;
using FintrakERPIMSDemo.Notifications;
using FintrakERPIMSDemo.WebHooks;

namespace FintrakERPIMSDemo
{
    [DependsOn(
        typeof(FintrakERPIMSDemoCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class FintrakERPIMSDemoCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            FintrakERPIMSDemoLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = FintrakERPIMSDemoConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, FintrakERPIMSDemoMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<FintrakERPIMSDemoSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FintrakERPIMSDemoCoreModule).GetAssembly());
        }
