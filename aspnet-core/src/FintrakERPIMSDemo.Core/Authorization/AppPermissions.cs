namespace FintrakERPIMSDemo.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        public const string Pages_SomeOnes = "Pages.SomeOnes";
        public const string Pages_SomeOnes_Create = "Pages.SomeOnes.Create";
        public const string Pages_SomeOnes_Edit = "Pages.SomeOnes.Edit";
        public const string Pages_SomeOnes_Delete = "Pages.SomeOnes.Delete";
