...
namespace FintrakERPIMSDemo.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var someOnes = pages.CreateChildPermission(AppPermissions.Pages_SomeOnes, L("SomeOnes"));
            someOnes.CreateChildPermission(AppPermissions.Pages_SomeOnes_Create, L("CreateNewSomeOne"));
            someOnes.CreateChildPermission(AppPermissions.Pages_SomeOnes_Edit, L("EditSomeOne"));
            someOnes.CreateChildPermission(AppPermissions.Pages_SomeOnes_Delete, L("DeleteSomeOne"));
        ...
        {
            return new LocalizableString(name, FintrakERPIMSDemoConsts.LocalizationSourceName);
        }
    }
}
