...
namespace FintrakERPIMSDemo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : FintrakERPIMSDemoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("FintrakERPIMSDemo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
