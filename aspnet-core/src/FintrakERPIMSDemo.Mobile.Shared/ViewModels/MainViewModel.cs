...
using FintrakERPIMSDemo.Commands;
using FintrakERPIMSDemo.Core.Threading;
using FintrakERPIMSDemo.Models.NavigationMenu;
using FintrakERPIMSDemo.Services.Navigation;
...
using FintrakERPIMSDemo.ApiClient;
using FintrakERPIMSDemo.Controls;
using FintrakERPIMSDemo.Dto;
using FintrakERPIMSDemo.Extensions;
using FintrakERPIMSDemo.Localization;
using FintrakERPIMSDemo.UI;
using FintrakERPIMSDemo.UI.Assets;
using FintrakERPIMSDemo.Views;
using DependencyResolver = FintrakERPIMSDemo.Core.Dependency.DependencyResolver;
...
namespace FintrakERPIMSDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "FintrakERPIMSDemo";
