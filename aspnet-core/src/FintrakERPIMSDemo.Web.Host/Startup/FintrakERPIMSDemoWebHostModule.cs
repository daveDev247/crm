...
using FintrakERPIMSDemo.Web.Startup.ExternalLoginInfoProviders;
...
namespace FintrakERPIMSDemo.Web.Startup
{
    ...
    public class FintrakERPIMSDemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public FintrakERPIMSDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FintrakERPIMSDemoWebHostModule).GetAssembly());
        }
