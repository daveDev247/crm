...
using FintrakERPIMSDemo.Web.Models.Consent;

namespace FintrakERPIMSDemo.Web.Host.Controllers
{
    public class ConsentController : FintrakERPIMSDemoControllerBase
    {
