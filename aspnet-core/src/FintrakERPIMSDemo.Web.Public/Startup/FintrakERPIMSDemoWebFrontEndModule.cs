...
namespace FintrakERPIMSDemo.Web.Public.Startup
{
    [DependsOn(
        typeof(FintrakERPIMSDemoWebCoreModule)
    )]
    public class FintrakERPIMSDemoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public FintrakERPIMSDemoWebFrontEndModule(IWebHostEnvironment env, FintrakERPIMSDemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FintrakERPIMSDemoWebFrontEndModule).GetAssembly());
        }
    }
}
