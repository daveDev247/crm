...
using FintrakERPIMSDemo.Web.Public.Startup;
using FintrakERPIMSDemo.Web.Session;

namespace FintrakERPIMSDemo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : FintrakERPIMSDemoViewComponent
    {
